...
interface Bundle {
     ...
     */
    operator fun <Read : Any, T : Any> get(permission: Read, property: Property<out T, Read, *>): T
     ...
     * @throws NoSuchElementException if the specified [property] was not set before and no default value is provided.
     */
    operator fun <Read : Any, T : Any> get(
        permission: Read,
     ...
     * @throws NoSuchElementException if the specified [property] was not set before and no default value is provided.
     */
    operator fun <T : Any> get(property: Property<out T, Any, *>): T

    /**
     * Return a [ReactiveValue] always holding the value of the specified [property] in this [Bundle], or the [Property.default] value, if not present.
     * @throws NoSuchElementException if the specified [property] was not set before and no default value is provided.
     */
    operator fun <T : Any> get(property: ReactiveProperty<out T, Any, *>): ReactiveValue<T>
     ...
     */
    operator fun <Write : Any, T : Any> set(write: Write, property: Property<in T, *, Write>, value: T)

 ...
 *
 * @see NullableListEditor
 * @see ListEditor
 */
@ProvideFeature
abstract class AbstractListEditor<R, E : Editor<R>, L : List<R>?>(
    context: Context,
    ...
    private val editorClass = getTypeArgument(AbstractListEditor::class, 1).jvmErasure
    ...
    private class AddEdit<E : Editor<*>>(
        private val editor: VirtualEditor<AbstractListEditor<*, E, *>>,
